    ...
    <>
      <section className="relative flex flex-col md:flex-row items-center justify-center min-h-screen bg-gradient-to-br from-blue-950 via-purple-700 to-pink-400 text-white text-center p-10 overflow-hidden">
        ...
        <div className="relative z-10 flex-1 flex flex-col items-center md:items-start">
          <h1 className="font-extrabold text-4xl md:text-6xl mb-4 text-transparent bg-clip-text bg-gradient-to-r from-blue-300 via-purple-300 to-pink-300 drop-shadow-lg transition-all">
            Hi, I'm Sanduni Lasara
          </h1>
          <p className="text-emerald-400 md:text-2xl mb-8 max-w-2xl">
            Welcome to My Portfolio.<br />
            </p>
          <p className="text-amber-50 md:text-lg mb-8 max-w-xl">
            I’m an undergraduate student in Information Technology at the Institute of Technology University of Moratuwa.
            This is my personal portfolio website, where you can find information about my skills, projects, and experience that I've built during my academic journey.</p>
          <a
            href="Doc1.docx"
        ...
        <div className="relative z-10 flex-1 flex justify-center mt-10 md:mt-0">
          <div className="relative group">
            <img
              ...
              alt="Sanduni Lasara"
              className="w-64 h-64 md:w-100 md:h-100 object-cover rounded-full shadow-2xl border-4 border-purple-300 transition-transform duration-300 group-hover:scale-105"
            />
